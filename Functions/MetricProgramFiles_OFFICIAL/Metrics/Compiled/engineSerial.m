...
%function engineSerial(cellmaskfilenames, nucleusmaskfilenames, cytomaskfilenames, stainfilenames, stainorder, outfilename)

function engineSerial(cellmaskfilenames, nucleusmaskfilenames, stainfilenames, stainorder, outfilename)
...
metricfunctions{1} = struct('name', 'A_ComputeCellSize', 'func', str2func('A_ComputeCellSize'), 'skip', 0, 'number', -1);
metricfunctions{2} = struct('name', 'B_ComputeNucleusAxisLengthAndRatio', 'func', str2func('B_ComputeNucleusAxisLengthAndRatio'), 'skip', 0, 'number', -1);
metricfunctions{3} = struct('name', 'B_ComputeNucleusMajorAxisLength', 'func', str2func('B_ComputeNucleusMajorAxisLength'), 'skip', 0, 'number', -1);
metricfunctions{4} = struct('name', 'C_ComputeNucleusMinorAxisLength', 'func', str2func('C_ComputeNucleusMinorAxisLength'), 'skip', 0, 'number', -1);
metricfunctions{5} = struct('name', 'D_ComputeNucleusCytoplasmRatio', 'func', str2func('D_ComputeNucleusCytoplasmRatio'), 'skip', 0, 'number', -1);
metricfunctions{6} = struct('name', 'E_ComputeCircularityElongation', 'func', str2func('E_ComputeCircularityElongation'), 'skip', 0, 'number', -1);
metricfunctions{7} = struct('name', 'F_ComputePolarity', 'func', str2func('F_ComputePolarity'), 'skip', 0, 'number', -1);
metricfunctions{8} = struct('name', 'G_Compute6TextureMetrics', 'func', str2func('G_Compute6TextureMetrics'), 'skip', 0, 'number', -1);
