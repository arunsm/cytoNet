...
%function engineParallel(cellmaskfilenames, nucleusmaskfilenames, cytomaskfilenames, stainfilenames, stainorder, outfilename)

function engineParallel(cellmaskfilenames, nucleusmaskfilenames, stainfilenames, stainorder, outfilename)
...
%metricfunctions{1} = struct('name', 'H_Compute5GLCMMetrics', 'func', str2func('H_Compute5GLCMMetrics'), 'skip', 0, 'number', -1);
metricfunctions{1} = struct('name', 'I3_Compute5SIBMetrics', 'func', str2func('I3_Compute5SIBMetrics'), 'skip', 0, 'number', -1);
