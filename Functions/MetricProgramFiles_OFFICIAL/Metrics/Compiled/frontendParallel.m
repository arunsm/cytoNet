function frontendParallel(threads, inputfiledir, outfile)
% frontendParallel(threads, inputfiledir, outfile)
...
engineParallel(cellmaskfiles, nucleusmaskfiles, stainfiles, stainorder, outfile); 
